...
// Routines callable by the Nachos kernel
    ...
    char* User2System(int virtaddr, int limit); //sao chep buffer tu user vao system
    int  System2User(int virtaddr, int len, char* buffer); //chuyen du lieu tu system vao user
